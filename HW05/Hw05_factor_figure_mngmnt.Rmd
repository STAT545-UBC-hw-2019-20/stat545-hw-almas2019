...
Lets reorder our factor of country based on maximum gdp Per Capita.
...
gapminder %>%
  ...
  coord_flip()+
  theme_bw() +
 ylab("GDP Per Captial") + xlab("Continent") +
...
median_gap <- gapminder %>%
 ...
 ggplot(median_gap, aes( y=n_less_than_median,x=continent,fill=year))+
