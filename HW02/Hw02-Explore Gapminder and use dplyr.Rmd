...
We will look at continent as our categorical and population as our quantitative in the gapminder dataset. We will look at various summary stats in 2.1 and the distribution in 2.2. 
###2.1 : Summary Table
```{r}
gapminder %>% 
